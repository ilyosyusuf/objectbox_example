...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 962746769436741590),
      name: 'UserModel',
      lastPropertyId: const IdUid(3, 2467535257774565273),
      flags: 2,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3989823037934944284),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7093185180549780206),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2467535257774565273),
            name: 'email',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 962746769436741590),
